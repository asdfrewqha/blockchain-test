...
def deploy_contracts():
    try:
        ...
        contract_path = os.path.join(
            base_dir, "node_modules", "@openzeppelin", "contracts", "metatx", "MinimalForwarder.sol"
        )
        ...
        try:
            compiled_sol = compile_standard(
                {
                    "language": "Solidity",
                    "sources": {"MinimalForwarder.sol": {"content": source_code}},
                    "settings": {
                ...
                base_path=base_dir,
                allow_paths=[base_dir, os.path.join(base_dir, "node_modules")],
            )
        ...
        bytecode = compiled_sol["contracts"]["MinimalForwarder.sol"]["MinimalForwarder"]["evm"][
            "bytecode"
        ]["object"]
        ...
        context_path = os.path.join(
            base_dir, "node_modules", "@openzeppelin", "contracts", "context"
        )
        ...
        bytecode = compiled_sol["contracts"]["VotingTopic.sol"]["VotingManager"]["evm"]["bytecode"][
            "object"
        ]
