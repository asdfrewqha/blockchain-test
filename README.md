...
> ### Но у нашего проекта есть еще одна киллер фича - автоматический сбор на сервере с помощью CI/CD
> Для него вам нужно все так же записать данные в `.env`, дописать необходимую информацию в секреты репозитория и после такой настройки вы сможете любым комитом в `main` запустить автоматическую загрузку приложения на сервер.
> <img src='https://github.com/asdfrewqha/blockchain-test/blob/readme/Readme-photos/brave_screenshot_github.com.png'></img>
